...
export default function BestSection({ englishCity }) {
  const cards = useMemo(
    () => [
      {
        id: 1,
      ...
      },
      {
        ...
        icon: "agent",
        link: englishCity ? `/agents/${englishCity}` : "/agents",
      },
      {
        id: 3,
  ...
  return (
    <section
      dir="rtl"
      style={{
        background: "linear-gradient(180deg, #a92b31  0%, #ffffff 100%)",
        borderRadius: 14,
      }}
      className="pb-16 pt-8 px-4 bg-transparent"
    >
