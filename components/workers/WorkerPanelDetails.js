  ...
  const renderUpdateRibbon = () => {
    ...
    >
      <div style={{
        ...
        <RocketLaunchIcon style={{ fontSize: 24, color: "#bbb",  marginRight:8 }} />
        <span style={{ fontSize: 20, color: "#bbb", fontWeight: 500 }}>افزایش بازدید</span>
      </div>
    </Link>
    
    );
    
    return createPortal(ribbonContent, document.body);
  };
  ...
  return (
    <>
      ...
      <div className={Styles['worker-details-wrapper']}>
        <div className={Styles['worker-detail-header-wrapper']}>
